...
pd.concat([amazon, google, facebook, wikipedia, netflix, linkedin, instagram, craigslist, bing, chase, paypal, apple, microsoft, stackoverflow, wellsfargo, worldpress, ask])
